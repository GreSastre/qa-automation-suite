...
```
Error: locator.fill: Error: Selector "#mce_0" resolved to <textarea id="mce_0" aria-hidden="true">Your content goes here.</textarea>, <iframe> was expected
Call log:
  - waiting for locator('#mce_0').contentFrame().locator('body')
...
```ts
  ...
  4 |   const frame = page.frameLocator("#mce_0");
